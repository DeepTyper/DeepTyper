...
### _Please do not share_
Presently, this code is released for reviewers only. Please do not share it until November 4th, when we will make it available publicly in conjunction with the accompanying paper should it be included in FSE 2018.
...
When all repositories have been checked out, please make a copy of the "Repos" directory named "Repos-cleaned" (also in "data/"). We will use this copy to store tokenized TypeScript data without type annotations without altering the original projects. The remainder of our processing will take place from the root directory.
